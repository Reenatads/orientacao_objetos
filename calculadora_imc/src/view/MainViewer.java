...
public class MainViewer {
	...
	private void initialize() {
		...
		pesoTextField.setBounds(157, 91, 97, 25);
		...
		alturaLabel.setBounds(85, 132, 39, 14);
		...
		alturaTextField.setBounds(157, 127, 97, 25);
		appFrame.getContentPane().add(alturaTextField);
		
		JButton calcularButton = new JButton("Calcular");
		calcularButton.setBounds(85, 176, 169, 25);
		...
		resultPane.setBounds(85, 225, 169, 80);
